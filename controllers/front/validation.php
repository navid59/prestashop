...
class NetopiaValidationModuleFrontController extends ModuleFrontController
{
    /**
...
//            $payment_status = NTP_PS_OS_PENDING;
            $message = null;
        } else {
...
//        return $this->module->validateOrder($cart_id, $payment_status, $amount, $module_name, $message, array(), $currency_id, false, $secure_key);
        ...
        $this->setTemplate('module:netopia/views/templates/front/redirect.tpl');
    }
